                ...
                <div class="col-12 col-lg-6 mt-5  " id="signin">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <span class="fw-bold fs-5  text-capitalize text-black-50 ">Hello Admin..! Welcome Back! </span>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-lg-6 offset-lg-3">
                            <input type="text"  placeholder="Email" class="form-control" id="e2" value="<?php echo $email?>">
                        </div>
                    </div>

                    <div class="row mt-3">
                        <div class="col-12 col-lg-6 offset-lg-3">
                            <input type="password" placeholder="Password" class="form-control" id="p2" value="<?php echo $password?>">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-lg-4 offset-lg-4 d-grid">
                            <button class="btn btn-dark fw-bold" onclick="adminSignin()">Sign in</button>
                        </div>
                    </div>
