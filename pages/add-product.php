...
if (isAdmin()) {
    ...
    <div class="row mt-5">
        ...
        <div class="col-4 mt-3">
            ...
            <textarea type="text" id="productDescription" placeholder="Product Description" rows="10" maxlength="500"
        ...
        <div class="col-4">
            ...
            <input type="file" hidden="hidden" onchange="loadAdminAddProductImageList()" name="productImages_uploader"
                   id="productImages_uploader" accept="image/*" multiple>
